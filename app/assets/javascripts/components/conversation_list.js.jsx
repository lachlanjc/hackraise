...
var ConversationList = React.createClass({
        ...
        conversations = conversations.map(
          function(conversation) {
            conversation.expanded =
              this.props.conversationNumber == conversation.number
            return conversation
          }.bind(this)
        )
  ...
  toggleHandler: function(toggled) {
    return function(event) {
      ...
      var conversations = this.state.conversations.map(
        function(conversation) {
    ...
    return function(tag) {
      return function(event) {
        ...
        var removeTagEvent = function() {
          var conversations = this.state.conversations.map(function(
            conversation
          ) {
            if (conversation === removeFrom) {
              var filteredTagEvents = conversation.tag_events.filter(function(
                tagEvent
              ) {
