...
describe Webhook do
  ...
  describe "dispatch" do
    before do
      ...
      @webhook.body = %{{"id":"634d1cad-94e9-471c-b6dc-95ce18140b89","account_id":"f7dfb266-f88c-4219-9cc6-d4f0e9881de9","created_at":"2013-11-19T16:55:12Z","event":"hackraise.test.test","data":{"foo":"bar"}}}
    ...
    it "sends an HTTP request" do
      ...
      assert_requested(:post, "http://example.com") do |req|
        {
          body: @webhook.body,
          headers: { 'X-Hackraise-Webhook-Signature' => @expected_signature }
        }
      end
    end
  end
